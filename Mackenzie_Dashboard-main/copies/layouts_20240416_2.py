...
imprint_page = dbc.Container([
    ...
    dbc.Card(children=[
        ...
        dbc.CardBody(children=[
                        ...
                        html.P(['Alfred-Wegener-Institut, Helmholtz Centre for Polar and Marine Research, Am Handelshafen 12, 27570 Bremerhaven, Germany, Tel.: +49 (0)471 4831-0, Fax.: +49 (0)471 4831-1149, E-Mail:,LINK'
                        ]),
                        html.H6(['Legal form'], style={'font-size': '18px',"width": "100%","opacity": "unset"}),
                        ...
                        html.H6(['Representatives'], style={'font-size': '18px',"width": "100%","opacity": "unset"}),
                        html.P(['The Alfred Wegener Institute is legally represented by its Directorate: Prof. Dr. Antje Boetius (Director) Dr. Karsten Wurr (Administrative Director), VAT identification number according to § 27a Umsatzsteuergesetz: DE 114707273']),
                        
                        html.H6(['Editorial responsibility'], style={'font-size': '18px',"width": "100%","opacity": "unset"}),
                        html.P(['x']),
                        
                        html.H6(['Copyright'], style={'font-size': '18px',"width": "100%","opacity": "unset"}),
                        ...
                        html.H6(['Rights of use'], style={'font-size': '18px',"width": "100%","opacity": "unset"}),
                        html.P(['The Alfred Wegener Institute authorises the following private use of images on this website:']),
                        
                        html.H6(['x'], style={'font-size': '18px',"width": "100%","opacity": "unset"}),
                        html.P(['x']),
...
accessibility_page = dbc.Container([
    ...
    dbc.Card(children=[
        ...
        dbc.CardBody(children=[
                        html.H6(['Feedback and contact information:'],
                        style={'font-size': '18px',"width": "100%","opacity": "unset"}
                                ),
